...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/loginuser',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"UserType.verifiedFields"},
            };
        ...
        app.post('/verify-otp',
            ...
            function AuthController_verifyOtp(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/resent-otp',
            ...
            function AuthController_resendotp(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/reset_password',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"UserType.resetPasswordFields"},
            };
        ...
        app.get('/admin',
            ...
            function AdminController_index(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/driver',
            ...
            ...(fetchMiddlewares<RequestHandler>(DriverController.prototype.index)),

            function DriverController_index(request: any, response: any, next: any) {
            const args = {
            };
